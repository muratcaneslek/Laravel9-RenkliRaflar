          ...
          <ul class="menu-inner py-1">
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <ion-icon class="menu-icon" name="bag-handle-outline" style="color:purple;"></ion-icon>
              ...
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link">                
                <ion-icon class="menu-icon" name="globe-outline" style="color:#CA004C;"></ion-icon>
                <div data-i18n="Orders">Social</div>
              </a>
              </li>
